#include "view/metasprite/spriteimporter/frame.h"
...
bool MyApp::OnInit()
{
    SetAppDisplayName("UnTech SpriteImporter Editor");
    SetAppName("untech-spriteimporter-gui");
...
{
    using Frame = UnTech::View::MetaSprite::SpriteImporter::Frame;
