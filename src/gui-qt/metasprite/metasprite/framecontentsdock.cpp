...
#include "gui-qt/metasprite/metasprite/framecontentsdock.ui.h"
    ...
    , _entityHitboxTypeMenu(new QMenu(tr("Set Entity Hitbox Type"), this))
{
    ...
    connect(_flipObjHorizontally, &QAction::triggered,
            this, &FrameContentsDock::onFlipObjHorizontally);
    connect(_flipObjVertically, &QAction::triggered,
            this, &FrameContentsDock::onFlipObjVertically);
...
void FrameContentsDock::onFlipObjHorizontally()
{
    _document->frameObjectList()->editSelected_flipObjectHorizontally();
}

void FrameContentsDock::onFlipObjVertically()
{
