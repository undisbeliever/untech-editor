...
bin/untech-utsi2utms: $(call app-models, common snes sprite-importer metasprite utsi2utms) $(THIRD_PARTY)
...
bin/untech-metasprite-gui: $(call app-models, common snes metasprite) $(THIRD_PARTY)
bin/untech-metasprite-gui: $(call gui-widgets, common metasprite)
